...
export default function Landing() {
  return (
    <main className="w-full h-full min-h-screen flex flex-col gap-4">
      <Navbar />

      <div className="w-full h-full flex flex-col items-center gap-4">
        <div className="h-full w-full p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center items-center gap-4">
          <h1 className={cn(GeistPixelSquare.className, "text-6xl sm:text-7xl md:text-8xl text-center")}>
            your visual timeline
          </h1>

          <p className={cn("text-sm sm:text-base md:text-lg font-semibold text-muted-foreground text-center")}>
        ...
        <p className="text-right w-full text-xs text-muted-foreground px-4">scroll {"->"}</p>

        <div className="w-full h-full border-t overflow-x-auto overflow-y-hidden">
          <div className="h-full grid grid-cols-7 min-w-max min-h-max">
            <div className="max-w-[300px] col-span-1 border-b  border-r flex flex-col items-center gap-2 p-4">
            ...
            <div className="col-span-1 border-b w-[300px] border-r flex flex-col items-center gap-2 p-4">
              <p className="text-sm font-medium text-muted-foreground">
                Mar 06
              </p>
            ...
            <div className="co1 border-b w-[300px] flex flex-col items-center gap-2 p-4">
              <p className="text-sm font-medium text-muted-foreground">
                Dec 13
              </p>
